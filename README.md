...
* **Grid & Flexbox Layouts:** * **CSS Grid** used for the three-column promotional section.
    * **Flexbox** used for the navigation bar and the two-column footer.
* **Intentional Engagement:** Includes hover effects on navigation links and call-to-action buttons, along with card-hover animations.
...
- [x] Horizontal navigation with 4 links.
- [x] Large promotional hero banner.
- [x] Three-column main content with images and text.
- [x] Two-column footer with small logo and copyright info.
